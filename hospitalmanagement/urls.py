...
urlpatterns += [
    ...
    path('pregnant_women/', views.pregnant_women, name='pregnant_women'),
    path('gym_trainers/', views.gym_trainers, name='gym_trainers'),
    path('newborn_babies/', views.newborn_babies, name='newborn_babies'),
    path('basic_diet1/', views.basic_diet1, name='basic_diet'),
