...
def pregnant_women(request):
    return render(request, 'pregnant_women.html')

def gym_trainers(request):
    return render(request, 'gym_trainers.html')

def newborn_babies(request):
    return render(request, 'newborn_babies.html')

def basic_diet(request):
    # Your logic for the basic_diet view
    return render(request, 'basic_diet.html')

from django.shortcuts import render

def basic_diet1(request):
